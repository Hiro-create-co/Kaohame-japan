  ...
  return (
    ...
    >
      ...
      <header className="absolute left-0 right-0 top-0 z-[1000] bg-white/90 backdrop-blur-sm px-4 py-2 shadow-sm">
        <h1 className="text-center text-base font-bold text-amber-500">
          カオハメJAPAN
        </h1>
        ...
        {loading ? (
          <div className="flex h-full items-center justify-center">
            <div className="text-center">
              <div className="mx-auto mb-3 h-10 w-10 animate-spin rounded-full border-4 border-amber-200 border-t-amber-500" />
          ...
          <div className="flex h-full items-center justify-center">
            <div className="text-center p-4">
              ...
              <button
                ...
                className="mt-3 rounded-full bg-amber-500 px-4 py-2 text-sm font-medium text-white"
              >
                再読み込み
              </button>
            </div>
