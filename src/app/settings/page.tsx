          ...
          {user ? (
            <div>
              <div className="flex items-center gap-4">
                {avatarUrl ? (
                  ...
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-amber-100 text-amber-500 text-xl font-bold">
            ...
            <div>
              ...
              <button
                ...
                className="mt-4 w-full rounded-xl bg-amber-500 py-3.5 text-base font-bold text-white transition-colors active:bg-amber-600"
              >
                ログイン / 新規登録
              </button>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-300 px-4 py-3 text-base focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400"
              />
              <p className="mt-1 text-sm text-gray-400">
                パネル登録時に自動で入力されます
              </p>
